...
_See code: [src/commands/available-numbers/list.ts](https://github.com/jblack-vail/freeclimb-cli-cd-test/blob/v0.1.7/src/commands/available-numbers/list.ts)_
